<?php
    ...
    class Project
    {
        ...
        {
            $inf = '<i class="far fa-copyright"></i> 2020. Todos os Direitos Reservados. Software desenvolvido por UrbanCode.';
        ...
        {
            return "http://localhost/villacake/__system__/";
        }

        public static function baseUrlPhp()
        {
            return "http://localhost/villacake/";
        }

        public static function baseUrlAdm() {
            return "http://localhost/villacake/__system__/admin-area/";
        }
    
        public static function baseUrlAdmPhp() {
            return "http://localhost/villacake/admin-area/";
        }
